...
const QuestionOption = () => {
  ...
  return (
    <div className="bg-black rounded-md w-2/3 m-auto  mt-3 p-4 ">
      ...
      {context.addInput.map((value, index) => (
        <div className="flex gap-3 mb-2 items-center justify-center" key={index}>
          <p >{index + 1}</p>
          <input type="text" name="option" className="bg-gray-800 w-3/4 p-2 rounded-md" placeholder="Question option.."  required/>
